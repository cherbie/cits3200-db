# Generated by Django 2.2.4 on 2019-09-15 05:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration_type', models.CharField(choices=[('Y', 'Year'), ('M', 'Month')], default='Month', max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('members', models.ManyToManyField(through='fodb.fodb_date', to='fodb.funding_opportunity')),
            ],
        ),
        migrations.AddField(
            model_name='fodb_date',
            name='date',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fodb.important_date'),
        ),
        migrations.AddField(
            model_name='fodb_date',
            name='fodb',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fodb.funding_opportunity'),
        ),
    ]
